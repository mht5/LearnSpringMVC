...
public class BookServiceImpl implements BookService {
	...
	public BookServiceImpl() {
		...
		Category category2 = new Category(2, "Fiction");
		...
		books = new ArrayList<Book>();
		books.add(new Book(1L, "5634221", "Servlet & JSP: A Tutorial (2nd Edition)",
				category1, "Budi Kurniawan", new BigDecimal("54.99")));
		books.add(new Book(2L, "6578941", "C#: A Beginner's Tutorial (2nd Edition)",
